...
#include "../../../components/FileExplorerComponent.hpp"
...
public:
    ...
    AssetExplorerPanel(EditorAssetRepository& repository,
...
private:
    ...
    FileExplorerComponent fileExplorer_;
    ...
    void drawFolderTree() {
        ...
        for (auto& f: repository_.listAll()) {
