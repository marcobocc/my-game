...
#include "components/BoxColliderWidget.hpp"
#include "components/CameraWidget.hpp"
#include "components/RendererWidget.hpp"
...
public:
    InspectorPanel(const std::optional<std::string>* selectedObjectId,
        ...
        rendererWidget_(engine, gizmos, mutations),
