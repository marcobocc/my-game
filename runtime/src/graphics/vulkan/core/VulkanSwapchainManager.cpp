...
VulkanRenderTarget VulkanSwapchainManager::getSwapchainTarget(uint32_t imageIndex) const {
    return {swapchain_.swapchainExtent.width,
            swapchain_.swapchainExtent.height,
            swapchain_.swapchainImages[imageIndex],
            swapchain_.swapchainImageViews[imageIndex],
